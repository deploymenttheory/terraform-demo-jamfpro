...
resource "jamfpro_macos_configuration_profile_plist" "jamfpro_macos_configuration_profile_one" {
  name                = "tf-gd-ghatest-dt-mcp-accessibility_hearing_base-prod-v0.0.1"
