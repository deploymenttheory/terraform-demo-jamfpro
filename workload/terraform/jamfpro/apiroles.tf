...
resource "jamfpro_api_roles" "api_role_cicd_pipeline_1" {
  display_name = "apir-cicdpipeline1-crud"
  privileges   = []
}

resource "jamfpro_api_roles" "api_role_cicd_pipeline_2" {
  display_name = "apir-cicdpipeline2-crud"
  privileges   = []
}
resource "jamfpro_api_roles" "api_role_cicd_pipeline_3" {
  display_name = "apir-cicdpipeline3-crud"
  privileges   = []
}

resource "jamfpro_api_roles" "api_role_api_roles_1" {
  display_name = "apir-apiroles-crud"
  privileges   = ["Create API Roles", "Update API Roles", "Read API Roles", "Delete API Roles"]
}

resource "jamfpro_api_roles" "api_role_api_integrations_1" {
...
resource "jamfpro_api_roles" "api_role_advanced_computer_searches" {
...
resource "jamfpro_api_roles" "api_role_advanced_mobile_device_searches" {
